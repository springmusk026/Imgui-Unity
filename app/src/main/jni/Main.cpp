...
void SetupImgui() {
    ...
    // Setup display size
    int width = ((int (*)())(address+0x34CF62C))(); // public static int get_width() { }
    int height = ((int (*)())(address+0x34CF6B0))(); // public static int get_height() { }
    LOGD("Display size: %fx%f", (float)width, (float)height);
...
EGLBoolean hook_eglSwapBuffers(EGLDisplay dpy, EGLSurface surface) {
    ...
    int touchCount = (((int (*)())(address+0x35AECE0))()); // public static int get_touchCount() { }
    if (touchCount > 0) {
        UnityEngine_Touch_Fields touch = ((UnityEngine_Touch_Fields (*)(int))(address+0x35AE7F8))(0); // public static Touch GetTouch(int index) { }
